<template>
    <div class="list">
        ...
        <el-table border style="width: 100%" align='center' :data="article_list" @selection-change='onSelectionChange'>
            ...
            <el-table-column :prop="fields.create_time.info.prop" :label="fields.create_time.info.label" :formatter="formatterDate" :align="fields.create_time.style.align" :width="fields.create_time.style.width" :sortable="fields.create_time.info.sortable">
            </el-table-column>
            <el-table-column :prop="fields.title.info.prop" :label="fields.title.info.label" :align="fields.title.style.align" :sortable="fields.title.info.sortable">
            </el-table-column>
            ...
            <el-table-column label="操作" width="160" :context="_self">
